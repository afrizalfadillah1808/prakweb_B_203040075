...
<body id="home" class="scrollspy">
  ...
  <div class="navbar-fixed">
    <nav class="place c2" style="background-color: #a1887f  ;">
      <div class="container">
  ...
  <div class="slider">
    <ul class="slides">
      <li>
        <img alt="slider" src="assets/bg/book.jpg">
  ...
  <section id="about" class="about scrollspy" style="background-color: #d7ccc8 ;">
    <div class="container" >
      <div class="row">
                ...
                <div class="col s12 m6 l4">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <img class="activator cover" src="assets/img/<?= $bk['img']; ?>">
                    </div>
  ...
  <section id="contact" class="contact scrollspy" style="background-color: #d7ccc8 ;">
    <div class="container">
      <h3 class="light center">Contact Us</h3>
      <div class="row">
        <div class="col m12 s12">
          <div class="card-panel center brown lighten-1">
           <div class="row">
